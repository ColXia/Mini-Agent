...
async def test_anthropic_simple_completion():
    ...
    try:
        ...
        traceback.print_exc()
        pytest.fail(f"Anthropic test failed: {e}")
...
async def test_openai_simple_completion():
    ...
    try:
        ...
        traceback.print_exc()
        pytest.fail(f"OpenAI test failed: {e}")
...
async def test_anthropic_tool_calling():
    ...
    try:
        ...
        traceback.print_exc()
        pytest.fail(f"Anthropic tool calling test failed: {e}")
...
async def test_openai_tool_calling():
    ...
    try:
        ...
        traceback.print_exc()
        pytest.fail(f"OpenAI tool calling test failed: {e}")
...
async def test_multi_turn_conversation():
    ...
    try:
        ...
        traceback.print_exc()
        pytest.fail(f"Multi-turn conversation test failed: {e}")
