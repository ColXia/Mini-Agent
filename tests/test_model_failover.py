...
from mini_agent.schema import LLMProvider, LLMResponse, Message
...
class _FakeLLMClient:
    ...
    def __init__(self, *, api_key: str, provider: LLMProvider, api_base: str, model: str, retry_config=None):
...
async def test_failover_llm_client_switches_provider_on_error(monkeypatch):
    ...
    _FakeLLMClient.behavior = {
        ...
        ("https://openai.example.com/v1", "gpt-4o-mini"): LLMResponse(
