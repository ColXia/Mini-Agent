...
class SkillLoader:
    ...
    def load_skill(self, skill_path: Path) -> Optional[Skill]:
        ...
        try:
            ...
            if not frontmatter_match:
                print(f"[!]  {skill_path} missing YAML frontmatter")
                return None
            ...
            try:
                ...
                print(f"[X] Failed to parse YAML frontmatter: {e}")
                return None

            # Required fields
            if "name" not in frontmatter or "description" not in frontmatter:
                print(f"[!]  {skill_path} missing required fields (name or description)")
                return None
            ...
            print(f"[X] Failed to load skill ({skill_path}): {e}")
            return None
    ...
    def discover_skills(self) -> List[Skill]:
        ...
        if not self.skills_dir.exists():
            print(f"[!]  Skills directory does not exist: {self.skills_dir}")
            return skills
