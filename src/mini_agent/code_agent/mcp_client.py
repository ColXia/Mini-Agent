"""Code-agent MCP client baseline (discovery + invocation + declarative wrapper)."""
...
from mini_agent.code_agent.mcp_tools import build_declarative_mcp_registry
from mini_agent.code_agent.tools import DeclarativeTool
...
class MCPToolDescriptor:
    """Compact MCP tool metadata used by code-agent orchestration."""
...
class CodeAgentMCPClient:
    """Lean MCP client manager for code-agent specific workflows."""
