...
_COMPAT_EXPORTS: dict[str, tuple[str, str]] = {
    "MainAgentSurfaceAssembly": (".facades.surface_service_assembly", "MainAgentSurfaceAssembly"),
    "assemble_main_agent_surface_service": (
        ".facades.surface_service_assembly",
        "assemble_main_agent_surface_service",
    ),
    "assemble_runtime_backed_main_agent_surface_service": (
        ".facades.surface_service_assembly",
    ...
    "build_main_agent_surface_service": (".facades.surface_service_assembly", "build_main_agent_surface_service"),
    "build_runtime_backed_main_agent_surface_service": (
        ".facades.surface_service_assembly",
        "build_runtime_backed_main_agent_surface_service",
    ),
