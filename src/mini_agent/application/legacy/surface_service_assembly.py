"""Legacy/transitional surface assembly helpers kept for compatibility during V11.1 migration."""
...
class MainAgentSurfaceAssembly:
    """Compatibility assembly over explicit user-service-owned dependencies."""
...
def assemble_main_agent_surface_service(
    *,
    ...
    """Assemble the compatibility surface from explicit user-service owners."""
...
def assemble_runtime_backed_main_agent_surface_service(
    *,
    ...
    """Assemble a compatibility surface directly from a runtime-backed user-service graph."""
...
def build_main_agent_surface_service(
    *,
    ...
    """Build the compatibility surface while preferring explicit user-service assembly."""
...
def build_runtime_backed_main_agent_surface_service(
    *,
    ...
    """Build a compatibility surface directly from a runtime-backed user-service graph."""
