...
from mini_agent.application.session_service import ManagedSessionTurn
...
GatewayActivityEmitter = SurfaceActivityEmitter
GatewayAgentExecutionHandler = AgentTurnExecutionHandler
GatewayAgentExecutionRequest = SurfaceAgentExecutionRequest

__all__ = [
    "SurfaceActivityEmitter",
    "AgentTurnExecutionHandler",
    "SurfaceAgentExecutionRequest",
    "GatewayActivityEmitter",
    "GatewayAgentExecutionHandler",
    "GatewayAgentExecutionRequest",
]
